...
class NavigationToolbar(QToolBar):
    def __init__(self, parent: QWidget):
        ...
        self.open_ghost_action.setToolTip(self.tr('Load spectrometer data as a background curve'))
        ...
        self.differentiate_action.setToolTip(self.tr('Calculate finite-step second derivative'))
        self.addSeparator()
